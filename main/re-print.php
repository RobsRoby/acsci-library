      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Re-Print LRN Barcode</h1>
...
<div class="container-fluid" align="center">
    ...
    <div class="card mb-4 py-3 border-bottom-primary">
            ...
            <form method="post" action="exportlrngrade11.php">
            <select name="section11" required>
        ...
        <input type="submit" name="export" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" value="Grade 11">
            </form>
            <BR>
            <form method="post" action="exportlrngrade12.php">
              <select name="section12" id="novalue" required>
               <option disabled selected value> -- select a Section -- </option>
              <?php
              ...
              <input type="submit" name="export" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" value="Grade 12">
            </form>
