...
<div class="container-fluid" align="center">
    ...
    <div class="card mb-4 py-3 border-bottom-primary">
            ...
            <form method="post" action="exportdb.php">
              <h2>Export Database</h2>
              <br><br>
        <input type="submit" name="export" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" value="Export Database">
            </form>
            ...
            <br />
            <input type="submit" name="import" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" value="Import">
           </form>
