...
<head>
  ...
  <title>Library - Grade 11 Books Return</title>
  ...
  <div id="wrapper">
   ...
   <!-- Page Heading -->
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Grade 11 | Rerurn Books</h1>
          </div>
            ...
            <div class="card mb-4 py-3 border-bottom-primary">
                <div class="card-body">
                  View 
                  <form method="post" action="grade11scan.php">
...
<div class="card shadow mb-4">
            ...
            <div class="card-body">
              ...
              <form action="createtablebooks11.php" method="post" target="_blank" >
                 <style>
  .barbar2 {
