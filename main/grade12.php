...
<head>
  ...
  <title>Admin - Grade 12 List</title>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Grade 12 Students</h1>
...
<div class="card shadow mb-4">
            ...
            <div class="card-body">
              <div class="table-responsive">
                <div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4"><div class="row"><div class="col-sm-12 col-md-6"><div class="dataTables_length" id="dataTable_length"><label>
                
                <form method="POST" action="grade11.php">
                ...
                <div id="dataTable_filter" class="dataTables_filter" >
                  <form action="grade11.php" method="POST" align="center">
                  <label>Search:
...
if(isset($_POST['search']))
{
    ...
    $sql = "SELECT * FROM ".$datatable." WHERE CONCAT( `LRN` , `Name` , `Section`) LIKE '%".$valueToSearch."%' ORDER BY LRN ASC LIMIT $start_from, ".$results_per_page;
    $search_result = filterTable($sql);
    
}
 else {
    $sql = "SELECT * FROM ".$datatable." ORDER BY Section,Name ASC LIMIT $start_from, ".$results_per_page;
    $search_result = filterTable($sql);
};
...
?>
              <form action="grade12.php" method="POST">
...
<?php } ?> 
              ...
              entries</div></div><div class="col-sm-12 col-md-7"><div class="dataTables_paginate paging_simple_numbers" id="dataTable_paginate">
                ...
                ?>
                 <li class="paginate_button page-item active"><a href="grade11.php?page=<?php echo $i; ?>" aria-controls="dataTable" data-dt-idx="1" tabindex="0" class="page-link"><?php echo $i; ?></a></li>
