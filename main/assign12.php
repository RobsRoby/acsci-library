...
<head>
  ...
  <title>Library - Grade 12 Books Assign</title>
  ...
  <div id="wrapper">
   ...
   <!-- Page Heading -->
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Grade 12 |  Books Assign</h1>
          </div>
            ...
            <div class="card mb-4 py-3 border-bottom-primary">
                <div class="card-body">
                  View 
                  <form method="post" action="assign12.php">
...
<div class="card shadow mb-4">
 ...
 <script type="text/javascript">
              ...
              <form action="updateassignrows12.php" target="_blank" method="post">
                    <style>
  .barbar2 {
 ...
 <?php while ($row=mysqli_fetch_assoc($search_result)){ ?>                     
                      ...
                      <td><input type="Text" name="book1"  class="barbar2"> <?php echo $row['Book1']; ?><center><br><input type="checkbox" name="check_list[]" value="Book1"></center></td>
                      <td><input type="Text" name="book2"  class="barbar2"><?php echo $row['Book2']; ?><center><br><input type="checkbox" name="check_list[]" value="Book2"></center></td>
                      <td><input type="Text" name="book3"  class="barbar2"><?php echo $row['Book3']; ?><center><br><input type="checkbox" name="check_list[]" value="Book3"></center></td>
                      <td><input type="Text" name="book4"  class="barbar2"><?php echo $row['Book4']; ?>  <center> <br><input type="checkbox" name="check_list[]" value="Book4"></center></td>
                      <td><input type="Text" name="book5"  class="barbar2"><?php echo $row['Book5']; ?><center><br><input type="checkbox" name="check_list[]" value="Book5"></center></td>
                      <td><input type="Text" name="book6"  class="barbar2"><?php echo $row['Book6']; ?><center><br><input type="checkbox" name="check_list[]" value="Book6"></center></td>
                      <td><input type="Text" name="book7"  class="barbar2"><?php echo $row['Book7']; ?><center><br><input type="checkbox" name="check_list[]" value="Book7"></center></td>
                      <td><input type="Text" name="book8"  class="barbar2"><?php echo $row['Book8']; ?><center><br><input type="checkbox" name="check_list[]" value="Book8"></center></td>
                      <td><input type="Text" name="book9"  class="barbar2"><?php echo $row['Book9']; ?><center><br><input type="checkbox" name="check_list[]" value="Book9"></center></td>
                    </tr>
<?php } ?> 
                  </tbody>
                </table> 
              ...
              <input type="submit" name="submitbook" value="Add All" onclick="return confirm('Are you sure you want to add this data? Data might overwrite.')">      
              <br><br>
              </form>
