...
<head>
  ...
  <title>LMBS - Library Security</title>
...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Question No.1</h1>
		<p>
    <?php 
    ...
    <?php
          ...
          {
             header("Location:librarysecurity2.php");
          }
    ...
    ?>
        ...
        <div class="container-fluid" align="center">
          <p>Answer:</p>
				    ...
				    <Form method="POST" action="librarysecurity.php">
              <input type="text" name="answer" size="60%" id="myInput">
              <br><br>
              <button onclick="document.getElementById('myInput').value = ''" class="btn btn-danger btn-circle btn-lg">
                    <i class="fas fa-trash"></i>
                  </button>
              &nbsp
              <button type="submit" name="submit" class="btn btn-success btn-circle btn-lg">
