...
<head>
  ...
  <title>Admin - Clearance List</title>
            ...
            <div class="card-body">
              <div class="table-responsive">
                ...
                <div id="dataTable_filter" class="dataTables_filter" >
                  <form action="clearance.php" method="POST" align="center">
                  <label>Search:
                  ...
                  <thead>
                    <tr role="row"><th class="sorting_asc" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column descending" style="width: 57px;"></th><th class="sorting_asc" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column descending" style="width: 57px;">LRN</th><th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="Position: activate to sort column ascending" style="width: 62px;">Name</th><th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="Office: activate to sort column ascending" style="width: 51px;">Section</th></tr>
                  </thead>
                  <tfoot>
                    <tr><th rowspan="1" colspan="1"></th><th rowspan="1" colspan="1">LRN</th><th rowspan="1" colspan="1">Name</th><th rowspan="1" colspan="1">Section</th></tr>
                  </tfoot>
                  <tbody>
...
<?php while ($row=mysqli_fetch_assoc($search_result)){ ?>                     
                  <tr role="row" class="even">
                     <td width="1%"><input type="checkbox" name="check_list[]" value="<?php echo $row['LRN']; ?>"></td>
...
<?php } ?> 
             ...
             $datatable= $_POST['tableoncemore'];
              ...
              entries</div></div><div class="col-sm-12 col-md-7"><div class="dataTables_paginate paging_simple_numbers" id="dataTable_paginate">
                ...
                ?>
                 <li class="paginate_button page-item active"><a href="clearance.php?page=<?php echo $i; ?>" aria-controls="dataTable" data-dt-idx="1" tabindex="0" class="page-link"><?php echo $i; ?></a></li>
