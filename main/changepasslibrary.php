...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Change Library Pasword</h1>
    ...
    ?>
    <br><br>
    <form method="POST" action="changepasslibrary.php">
      ...
      <input type="submit" name="submitchangepasslibrary" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-lg">
    </form>
