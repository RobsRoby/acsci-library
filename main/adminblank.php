...
<div class="container-fluid" style="text-align: center;">
  ...
  <div class="col-lg-6" align="center">
    ...
    <form method="POST" action="adminblank.php">
      <input type="text" name="newpass" value="<?php echo $results['username']; ?>" disabled>
      <br><br>
      <input type="password" name="newpass" id="myInput" value="<?php echo $results['password']; ?>">
      <br>
      <input type="checkbox" onclick="myFunction()">Show Password
      <br><br>
      <a href="changequestionadmin.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-lg">Change Question</a>
      <br><br>
      <input type="submit" name="submitchangepassadmin" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-lg" value="Change Password" onclick="return confirm('Are you sure you want to change Password?')">
    </form>
 ...
 <div class="col-lg-6" align="center">
        ...
        If (isset($_POST['submitchangepasslibrary'] )){ 
        $newpass=$_POST['newpass'];
        $query="UPDATE login SET password='$newpass' WHERE username='library'";
        mysqli_query($db, $query);
        echo "Password updated successfully..";
        }
    ...
    <form method="POST" action="adminblank.php">
      <input type="text" name="newpass" value="<?php echo $results['username']; ?>" disabled>
      <br><br>
      <input type="password" name="password" id="myInput1" value="<?php echo $results['password']; ?>">
      <br>
      <input type="checkbox" onclick="myFunction1()">Show Password
      <br><br>
      <a href="changequestionlibrary.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-lg">Change Question</a>
      <br><br>
      <input type="submit"  value="Change Password" name="submitchangepasslibrary" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-lg" onclick="return confirm('Are you sure you want to change Password?')">
    </form>
        </div>
              </div>
