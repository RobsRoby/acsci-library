      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Reprint Book Barcode</h1>
...
<div class="container-fluid" align="center">
    ...
    <div class="card mb-4 py-3 border-bottom-primary">
            ...
            <form method="post" action="exportbook.php">
            <select name="booktitle" required>
               <option disabled selected value> -- Book Listed -- </option>
              <?php
              include 'connection.php';
               $sql="SELECT * FROM registeredbooks group by Book";
        ...
        <input type="submit" name="export" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" value="Print">
            </form>
            <BR>
