...
<head>
  ...
  <title>Admin - Register Book</title>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Register Books</h1>
...
<style>
 ...
 <?php
            ...
            If (isset($_POST['scancomplete'] ))
          {
          $_SESSION["data1"] = $_POST['booktitle'];
          $_SESSION["data"] = $_POST['bookcode'];
          $data= $_SESSION["data"];
          $title= $_SESSION["data1"];
          }
          else{
            $data="";
          }
            ...
            If (isset($_POST['scancomplete'] ))
          {
            ...
            $query = "INSERT INTO registeredbooks (code, book) VALUES('$data', '$title')";
...
?>
        ...
        <div class="card mb-4 py-3 border-bottom-primary">
                <div class="card-body">
<p>Re-register A Book</p>
<form>
<input type="text" class="barbar2" value="<?php echo $data; ?>" disabled>
<input type="button" value="Scan" data-toggle="modal" data-target="#scanModal">
</form>
  ...
  <div class="col-lg-6" align="center">
        ...
        <div class="card mb-4 py-3 border-bottom-primary">
            ...
            If (isset($_POST['addbooks'] ))
          {
            ...
            $grade=$_POST['gradeadd'];
            $book_check_query = "SELECT * FROM registeredbooks WHERE book='".$booktitle."' LIMIT 1";
              $bookresult = mysqli_query($db, $book_check_query);
              $bookuser = mysqli_fetch_assoc($bookresult);
          
              If($bookuser['book'] == $booktitle){
                ...
                while($x <= $quantity) {
            $codenumber= $code.$x;
            $code_check_query = "SELECT * FROM registeredbooks WHERE book='".$codenumber."' LIMIT 1";
              $coderesult = mysqli_query($db, $code_check_query);
              $codeuser = mysqli_fetch_assoc($coderesult);
          
              If($codeuser['book'] == $codenumber){
            ...
            $query = "INSERT INTO registeredbooks (code, book, grade) VALUES('".$codenumber."', '$booktitle', '$grade')";
            mysqli_query($db, $query);
              }
            $x++; 
              } 
          ...
          <form method="POST" action="register.php">
           <input name="book" type="text" placeholder="Book Title" required><br><br>
           <input type="text" name="code" placeholder="CodeName" required><br><br>
          <input type="text" name="quantity" placeholder="Quantity" required><br><br>
           <select name="gradeadd" required><br><br>
             <option disabled selected value> -- select a Grade -- </option>
             <option value="11">Grade 11</option><br><br>
             <option value="12">Grade 12</option><br><br>
           </select><br><br>
...
?>
  <div class="modal fade" id="scanModal" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
        ...
        <div class="modal-body">
          ...
          <br><br>
          <p>Click the Textbox & Press the scanner..</p>
          <input type="text" name="bookcode" autofocuS required>
          <br><br>
          <button class="btn btn-primary" type="submit" name="scancomplete">Confirm</button>
          <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
          </form>
