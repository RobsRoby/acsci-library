...
<head>
  ...
  <title>Library - Clearance List</title>
            ...
            <div class="card-body">
              <div class="table-responsive">
                <div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4"><div class="row">
                  ...
                  <form action="clearancelibrary.php" method="post">
                  <button value="clearancegrade11" type="submit" name="gradeview">Grade 11</button> 
                  <br><br>
                  <button value="clearancegrade12" type="submit" name="gradeview">Grade 12</button>
                  </form>
                  </div>

                  <div class="col-sm-12 col-md-3"><div class="dataTables_length" id="dataTable_length"><label>
                
                <form method="POST" action="clearancelibrary.php">
                ...
                <div id="dataTable_filter" class="dataTables_filter" >
                  <form action="clearancelibrary.php" method="POST" align="center">
                  <label>Search:
                    
                    <?php 
                    $datatable="clearancegrade11";
                    if(isset($_POST['gradeview']))
                  {
                  $_SESSION["dataview"] = $_POST['gradeview'];
                  $datatable= $_SESSION["dataview"];
                  } 
                  ?>
                    <input type="hidden" name="tableoncemore" value="<?php  echo $datatable; ?>">
                  ...
                  <thead>
                    <tr role="row"><th class="sorting_asc" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column descending" style="width: 57px;">LRN</th><th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="Position: activate to sort column ascending" style="width: 62px;">Name</th><th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="Office: activate to sort column ascending" style="width: 51px;">Section</th><th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="Office: activate to sort column ascending" style="width: 51px;">Date Cleared</th></tr>
                  </thead>
                  <tfoot>
                    <tr><th rowspan="1" colspan="1">LRN</th><th rowspan="1" colspan="1">Name</th><th rowspan="1" colspan="1">Section</th><th rowspan="1" colspan="1">Date Cleared</th></tr>
                  </tfoot>
                  <tbody>
...
{
  $datatable= $_POST['tableoncemore'];
    $valueToSearch = $_POST['valueToSearch'];
    $sql = "SELECT * FROM ".$datatable." WHERE checkornot='check' AND CONCAT( `LRN` , `name` , `section`) LIKE '%".$valueToSearch."%' ORDER BY LRN ASC LIMIT $start_from, ".$results_per_page;
    $search_result = filterTable($sql);
    
}
 else {
    $sql = "SELECT * FROM ".$datatable." WHERE checkornot='check' ORDER BY section,name ASC LIMIT $start_from, ".$results_per_page;
    $search_result = filterTable($sql);
};
...
<?php while ($row=mysqli_fetch_assoc($search_result)){ ?>                     
                  <tr role="row" class="even">
                      <td class="sorting_1"><?php echo $row['LRN']; ?></td>
                      <td><?php echo $row['name']; ?>r</td>
...
<?php } ?> 
             ...
             $datatable= $_POST['tableoncemore'];
              foreach($_POST['check_list'] as $selected){
                ...
                $sql="DELETE FROM ".$datatable." WHERE LRN=".$selected;
                mysqli_query($db, $sql);
              ...
              $sql="SELECT count(LRN) AS total FROM ".$datatable." WHERE checkornot='check'";
              ...
              entries</div></div><div class="col-sm-12 col-md-7"><div class="dataTables_paginate paging_simple_numbers" id="dataTable_paginate">
                ...
                ?>
                 <li class="paginate_button page-item active"><a href="clearancelibrary.php?page=<?php echo $i; ?>" aria-controls="dataTable" data-dt-idx="1" tabindex="0" class="page-link"><?php echo $i; ?></a></li>
