      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Admin Questions</h1>
...
<div class="container-fluid" align="center">
    ...
    <div class="card mb-4 py-3 border-bottom-primary">
        ...
        $query="UPDATE login SET question='$newquestion',answer='$newanswer' WHERE username='admin'";
    ...
    ?>
    <br>
    <form method="POST" action="changequestionadmin.php">
      <b>Question</b><br>
...
<br>
        ...
        $query="UPDATE login SET question1='$newquestion1',answer1='$newanswer1' WHERE username='admin'";
        mysqli_query($db, $query);
        echo "Updated successfully..";
        }
