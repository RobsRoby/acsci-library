...
<head>
  ...
  <title>Library - Grade 11 Books Assign </title>
  ...
  <div id="wrapper">
   ...
   <!-- Page Heading -->
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Grade 11 | Books Assign</h1>
          </div>
            ...
            <div class="card mb-4 py-3 border-bottom-primary">
                <div class="card-body">
                  View 
                  <form method="post" action="assign11.php">
                  <input type="Text" name="lrn" id="inputlrn" autofocus required>
          ...
          <script>
            ...
            window.onload = function() {
                ...
                var lrn = sessionStorage.getItem('name');
                if (lrn !== null) $('#inputlrn').val(lrn);
            ...
            window.onbeforeunload = function() {
                sessionStorage.setItem("lrn", $('#inputlrn').val());
...
If (isset($_POST['submitlrn'] )){  
  ...
  $user_check_querylrn = "SELECT * FROM grade11 WHERE LRN=".$lrn." LIMIT 1";
...
<div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">LRN No.<?php echo $userlrn['LRN'];?></h6>
            </div>
            <div class="card-body">
 ...
 <script type="text/javascript">
              ...
              <form action="updateassignrows11.php" target="_blank" method="post">
                <style>
  .barbar2 {
 ...
 <?php while ($row=mysqli_fetch_assoc($search_result)){ ?>                     
                      ...
                      <td><input type="Text" name="book1" class="barbar2"><br><br><center> <?php echo $row['Book1']; ?></center><center><br><input type="checkbox" name="check_list[]" value="Book1"></center></td>
                      <td><input type="Text" name="book2" class="barbar2"><br><br><center><?php echo $row['Book2']; ?></center><center><br><input type="checkbox" name="check_list[]" value="Book2"></center></td>
                      <td><input type="Text" name="book3" class="barbar2"><br><br><center><?php echo $row['Book3']; ?></center><center><br><input type="checkbox" name="check_list[]" value="Book3"></center></td>
                      <td><input type="Text" name="book4" class="barbar2"><br><br><center><?php echo $row['Book4']; ?></center><center><br><input type="checkbox" name="check_list[]" value="Book4"></center></td>
                      <td><input type="Text" name="book5" class="barbar2"><br><br><center><?php echo $row['Book5']; ?></center><center><br><input type="checkbox" name="check_list[]" value="Book5"></center></td>
                      <td><input type="Text" name="book6" class="barbar2"><br><br><center><?php echo $row['Book6']; ?></center><center><br><input type="checkbox" name="check_list[]" value="Book6"></center></td>
                      <td><input type="Text" name="book7" class="barbar2"><br><br><center><?php echo $row['Book7']; ?></center><center><br><input type="checkbox" name="check_list[]" value="Book7"></center></td>
                      <td><input type="Text" name="book8" class="barbar2"><br><br><center><?php echo $row['Book8']; ?></center><center><br><input type="checkbox" name="check_list[]" value="Book8"></center></td>
                      <td><input type="Text" name="book9" class="barbar2"><br><br><center><?php echo $row['Book9']; ?></center><center><br><input type="checkbox" name="check_list[]" value="Book9"></center></td>                
                    </tr>
<?php } ?> 
                  </tbody>
                </table> 
              ...
              <input type="submit" name="updaterows" value="Clear" onclick="return confirm('Are you sure you want to clear this record/s?')">
              <input type="submit" name="submitbook" value="Add All" onclick="return confirm('Are you sure you want to add this data?')">   
              <br><br>
              </form>
